...
export function CenterCard({
 ...
 {/* Header Image */}
 <div className="h-40 bg-gradient-to-br from-violet-100 to-violet-50 flex items-center justify-center relative overflow-hidden">
 {image ? (
 <img src={image} alt={name} className="w-full h-full object-cover" />
 ) : (
 <div className="text-center">
 <div className="text-5xl mb-2">📍</div>
 <p className="text-sm text-violet-600 font-medium">{name}</p>
 </div>
 )}
 </div>
 ...
 <div className="flex items-center gap-3 text-slate-600">
 <Users size={18} className="text-violet-600 flex-shrink-0" />
