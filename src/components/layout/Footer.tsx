        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/centers" className="text-slate-400 hover:text-indigo-400 transition-colors text-sm">
                  Find a Center
                </Link>
              </li>
              <li>
                <Link href="/books" className="text-slate-400 hover:text-indigo-400 transition-colors text-sm">
                  Browse Books
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/refunds" className="text-slate-400 hover:text-indigo-400 transition-colors text-sm">
                  Refund Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-400 text-sm">123 Education Hub, Tech Park, Study City 1000</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:support@studyspace.com" className="text-slate-400 hover:text-indigo-400 transition-colors text-sm">
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm">
            <span className="text-slate-500 flex items-center gap-1">
              Made with <span className="text-indigo-500">&hearts;</span> for students
            </span>
          </div>
        </div>
      </div>
