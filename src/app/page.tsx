...
export default function Home() {
 ...
 {/* Feature 1 */}
 <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200 hover:border-violet-200 hover:shadow-lg transition-all">
 ...
 <div className="w-16 h-16 bg-violet-100 rounded-lg flex items-center justify-center flex-shrink-0 text-violet-600">
 {feature.icon}
 </div>
 <div>
 ...
 <div className="h-16 w-16 bg-violet-100 text-violet-600 rounded-2xl flex items-center justify-center mb-6 shadow-sm">
