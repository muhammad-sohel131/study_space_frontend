...
export default function BookSeatPage() {
 ...
 <Card>
 <h2 className="text-xl font-bold text-slate-900 mb-4">Select Time</h2>
 ...
 <h2 className="text-xl font-bold text-slate-900 mb-6">Select a Seat</h2>
 ...
 <div className="flex items-center gap-2 text-slate-700">
 <div className="w-6 h-6 rounded-md bg-violet-500 shadow-md"></div>
 <span>Selected</span>
 </div>
 <div className="flex items-center gap-2 text-slate-700">
 ...
 ${isSelected 
 ? 'bg-violet-500 text-white shadow-lg shadow-violet-500/40 -translate-y-1' 
 ...
 {/* Armrests simulation */}
 <div className={`absolute bottom-0 left-0 w-1.5 h-6 rounded-tr-md ${isSelected ? 'bg-violet-600' : 'bg-green-300'}`}></div>
 <div className={`absolute bottom-0 right-0 w-1.5 h-6 rounded-tl-md ${isSelected ? 'bg-violet-600' : 'bg-green-300'}`}></div>
 </button>
 )
 })}
 </div>
